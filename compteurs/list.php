<?php 
    require(dirname(__FILE__).'includes/connexion.php');
	...
	<a href="add_compteur.php" class="create-contact">Nouveau compteur</a>
        <table>
            ...
            <tr>
                ...
                <td><a href="edit.php?code=<?=$compteur['CodeCompteur'];?>">Editer</a></td>
                <td><a href="delete.php?code=<?=$compteur['CodeCompteur'];?>">Supprimer</a></td>
            </tr>
            <?php endforeach; ?>
        </table>
</div>
